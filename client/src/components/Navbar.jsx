...
const Navbar = () => {
    ...
    // Switch user role to owner and notify
  ...
  return (
    // Navbar container with animation on load
    ...
    >
        ...
        >
            ...
            {/* Role switch / dashboard & login/logout */}
            <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
                <button onClick={() => isOwner ? navigate("/owner") : changeRoll()} className='cursor-pointer'>
